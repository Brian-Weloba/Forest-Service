...
public class DatabaseRule extends ExternalResource {
    ...
    protected void before() {
        DB.sql2o = new Sql2o("jdbc:postgresql://localhost:5432/wildlife_tracker_test", "nyosh04", "nyongesa");  //Those with linux or windows use two strings for username and password
    }
